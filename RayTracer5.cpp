...
void addValues() {
    ...
    const auto triangle = object(Vector3D(0,0,2), Vector3D(1,2,2), Vector3D(-1,2,2), Vector3D(255,255,0), 500, 0.5);

    const auto yel = object(Vector3D(1,0,6), 1.0, Vector3D(255,255,0), 500, 0.4);
    const auto triangle2 = object(Vector3D(0,0,3), Vector3D(1,1,2), Vector3D(-1,2,2), Vector3D(255,100,255), 500, 0.5);
